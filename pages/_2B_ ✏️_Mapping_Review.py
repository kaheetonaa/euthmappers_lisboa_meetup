...
osm_data= osmium.FileProcessor("https://api06.dev.openstreetmap.org/api/0.6/map?bbox=32.5980379375112364%2C-20.2201205016708663%2C32.6519368546133677%2C-20.1662215845687349?discussion=true").with_areas().with_filter(osmium.filter.GeoInterfaceFilter())
