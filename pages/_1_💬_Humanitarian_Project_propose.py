...
if comment and comment!="":
    ...
    post={'bounds':st.session_state.bounds,'comment':comment,'center':'POINT('+str(st.session_state.location[0])+','+str(st.session_state.location[1])+')','zoom':st.session_state.zoom}
