...
if comment and comment!="":
    ...
    post={'bounds':'POLYGON (('+st.session_state.bounds['_southWest']['lat']+' '+st.session_state.bounds['_southWest']['lng']+','+st.session_state.bounds['_southWest']['lat']+' '+st.session_state.bounds['_northEast']['lng']+','+st.session_state.bounds['_northEast']['lat']+' '+st.session_state.bounds['_northEast']['lng']+','+st.session_state.bounds['_northEast']['lat']+' '+st.session_state.bounds['_southWest']['lng']+','+st.session_state.bounds['_southWest']['lat']+' '+st.session_state.bounds['_southWest']['lng']+'))','comment':comment,'center':'POINT ('+str(st.session_state.location[0])+' '+str(st.session_state.location[1])+')','zoom':st.session_state.zoom}
