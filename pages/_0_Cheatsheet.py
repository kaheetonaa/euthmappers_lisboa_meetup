...
qr_img = generate_qr_code('https://tasks.hotosm.org/projects/17927', '#000000', '#FFFFFF00')
#st.text("")
#st.text("")
#st.text("")
#st.text("")
...
qr_img = generate_qr_code('https://euthmapperslisbonmeetup.streamlit.app/2B_%E2%9C%8F%EF%B8%8F_Mapping_Review', '#000000', '#FFFFFF00')